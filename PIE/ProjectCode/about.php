<!DOCTYPE PHP>
<!--page will be replaced by about.php after we set up testing server-->
<!--This is the about page. Has image and tabbed section that displays information about
the PIE project. Currently three tabs that include our vision statement, info about events, and
the impact of the project to the current point. More work needs to be done on this page. -->
<html>
<head>
    <title>About</title>
