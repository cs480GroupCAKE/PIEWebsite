...
<?php
    ...
    $pending = "Y";
    $view = "<a href='./viewProfile?vusername=".$sender."'>View Profile</a>";
    
    $insert = "INSERT INTO notifications (username, sender, accept, decline, notice, view, eventid)
               VALUES('$recipient','$sender',\"$accept\",\"$decline\",'$notice',\"$view\",'0');";
